          ...
          {painPoints.map((point, i) => (
            <div key={i} className="glass rounded-xl p-5 border border-primary/20 hover:border-primary/40 transition-all duration-300">
              <div className="flex items-start gap-3">
                <span className="text-xs font-mono text-secondary font-bold uppercase tracking-[0.14em] px-2 py-1 rounded border border-secondary/30 bg-secondary/10 mt-0.5">
                  Risk
                </span>
