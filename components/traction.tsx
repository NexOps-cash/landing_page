...
const tractionItems = [
  ...
  'Active usage across BCH contract flows',
  'Continuous iteration from real-world audits',
]
    ...
    <section className="relative py-12 px-4 sm:px-6 lg:px-8 border-t border-primary/10">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          <p className="text-xs font-mono text-secondary uppercase tracking-[0.3em] mb-3">Traction</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {tractionItems.map((item, i) => (
            <div key={i} className="glass rounded-xl p-5 border border-secondary/20 hover:border-secondary/40 transition-all duration-300">
              <p className="text-[10px] font-mono text-secondary uppercase tracking-[0.24em] mb-2">
