    ...
    <section className="relative py-12 px-4 sm:px-6 lg:px-8 border-t border-primary/10">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          <p className="text-xs font-mono text-primary uppercase tracking-[0.3em] mb-3">Positioning</p>
        ...
        <div className="hidden md:block glass rounded-2xl border border-primary/20 overflow-hidden">
          <div className="grid grid-cols-12 border-b border-white/10 bg-white/[0.02]">
            <div className="col-span-4 px-5 py-4 text-xs font-mono uppercase tracking-[0.2em] text-white/70">Existing Stack</div>
            <div className="col-span-4 px-5 py-4 text-xs font-mono uppercase tracking-[0.2em] text-primary bg-primary/5">NexOps Equivalent</div>
            <div className="col-span-4 px-5 py-4 text-xs font-mono uppercase tracking-[0.2em] text-white/70">What You Actually Get</div>
          </div>
          ...
          {stackRows.map((row) => {
            ...
            return (
              <div key={row.existing} className="glass rounded-xl border border-primary/20 p-4">
                <p className="text-xs font-mono text-white/65 uppercase tracking-[0.18em] mb-1">Existing Stack</p>
                <p className="text-sm text-white/85 mb-3">{row.existing}</p>

                <p className="text-xs font-mono text-primary uppercase tracking-[0.18em] mb-1">NexOps Equivalent</p>
                <div className="inline-flex items-center gap-2 rounded-md border border-primary/25 bg-primary/10 px-2.5 py-1 mb-3">
                  <Icon className="w-4 h-4 text-primary" />
                  <span className="text-sm font-medium text-primary">{row.nexops}</span>
                </div>

                <p className="text-xs font-mono text-white/65 uppercase tracking-[0.18em] mb-1">What You Actually Get</p>
